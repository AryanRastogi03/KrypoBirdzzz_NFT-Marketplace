...
export default function Home() {
  ...
  async function loadNFTs() {
    ...
    const marketContract = new ethers.Contract(nftmarketaddress, CBMarket.abi, provider)
  ...
  async function buyNFT(nft) {
    ...
    const contract = new ethers.Contract(nftmarketaddress, CBMarket.abi, signer)
